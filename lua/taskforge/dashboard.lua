...
function M.get_snacks_dashboard_tasks()
  -- log()
	...
	section.title = config.options.dashboard.snacks_options.title
  section.pane = config.options.dashboard.snacks_options.pane or 1
	section.padding = config.options.dashboard.snacks_options.padding
	section.indent = config.options.dashboard.snacks_options.indent
	section.text = M.process_tasks_for_snacks()
	section.height = config.options.dashboard.snacks_options.height
		or #section.text + config.options.dashboard.snacks_options.padding + 1
	return section
end
...
function M.setup()
  ...
  -- log("Project: ", M.project)
	...
	-- 	callback = function()
	-- 		if api.nvim_get_current_buf() == dashboard_bffnr then
